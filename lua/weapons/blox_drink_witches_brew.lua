...
SWEP.PrintName = "Witches' Brew"
SWEP.Base = "blox_base_consumable"
SWEP.Category = "Bloxxer's Arsenal"
SWEP.Spawnable = false

SWEP.Description = "Do the Brew! Shipped direct from the Haunted Hill soda company. Warning: may cause freakish deformities. Warning: may contain actual witches."
